...
- NEXT SESSION: 1660/1661 + greedy set. Verify solves via /check (did he justify each sort key?). If full day, add bitmask/complete-search as 2nd Day-4 lesson. THEN Day 5 = DP I.
